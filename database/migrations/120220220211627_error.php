...
class Error extends Migrator
{
    ...
    {
        $table = $this->table('error', ['engine' => 'InnoDB', 'collation' => 'utf8_general_ci', 'comment' => '异常' ,'id' => 'id','signed' => true ,'primary_key' => ['id']]);
        $table->addColumn('project_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => null,'signed' => true,'comment' => '',])
			...
			->addColumn('md5', 'string', ['limit' => 32,'null' => true,'signed' => true,'comment' => '',])
            ->create();
    }
}
